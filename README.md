...
Passo 4: Após o Cubic carregar a ISO, será aberto uma janela de terminal azul; execute o script que fará as modificações na ISO com o comando `https://github.com/thiagoneo/linuxmint-custom-iso-pt-br/blob/main/run_inside_chroot.sh | bash`;
